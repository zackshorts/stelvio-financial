<template>
  <div>
    ...
    <div id="landing-picture">
      <h2 id="landing-picture-description">The Stelvio Pass is the highest paved mountain pass in the Eastern Alps</h2>
      <img class="picture-stretch" src="../assets/optimized-stelvio-images/night-min.jpg">
    </div>
    <div id="intro-grid">
      <h3 id="intro" data-aos="zoom-in">From personal wealth management to consulting, we’re one of the most trusted investment firms in Arizona</h3>
      <img id="landing-logo" data-aos="zoom-in" src="../assets/logo.png">
    </div>
    <div id="main-content-grid">
      <!-- LAYER ONE -->
      <div id="landing-1" data-aos="zoom-in-left">
      ...
      <!-- LAYER TWO -->
      <div id="landing-2" data-aos="zoom-in-right">
      ...
      <!-- LAYER THREE -->
      <div id="landing-3" data-aos="zoom-in-left">
      ...
      <!-- LAYER FOUR -->
      <div id="landing-4" data-aos="zoom-in-right">
        <h3>Our Process</h3>
